        ...
        <div className="bg-white shadow-sm rounded-lg p-8">
          ...
          <div className="space-y-8">
            <div className="text-gray-700">
              <p>
                この利用規約（以下「本規約」といいます。）は、合同会社アミュスフィア（以下「当社」といいます。）がこのウェブサイト上で提供するサービス（以下「本サービス」といいます。）の利用条件を定めるものです。
            ...
            {/* 退会 */}
            <section>
              <h2 className="text-xl font-bold text-gray-900 mb-4">第8条（退会）</h2>
              <div className="text-gray-700 space-y-3">
                <p>1. ユーザーは、当社の定める退会手続により、本サービスから退会できるものとします。</p>
                <p>2. 退会の場合、当該月の利用料金は日割り計算されず、返金されないものとします。</p>
                <p>3. 退会後も、本規約の規定のうちユーザーに適用されるべき規定は、引き続き効力を有するものとします。</p>
              </div>
            </section>

            {/* 保証の否認および免責事項 */}
            <section>
              <h2 className="text-xl font-bold text-gray-900 mb-4">第9条（保証の否認および免責事項）</h2>
              <div className="text-gray-700 space-y-3">
            ...
            <section>
              ...
              <div className="text-gray-700 space-y-3">
                <p>1. 当社は、ユーザーへの事前の告知をもって、本サービスの内容を変更、追加または廃止することがあり、ユーザーはこれに同意するものとします。</p>
                <p>2. 当社は、本サービスの全部または一部を終了する場合、ユーザーに対して事前に通知するものとします。</p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="text-gray-700 space-y-3">
                <p>1. ユーザーと当社との間の通知または連絡は、当社の定める方法によって行うものとします。当社は、ユーザーから、当社が別途定める方式に従った変更届け出がない限り、現在登録されている連絡先が有効なものとみなして当該連絡先へ通知または連絡を行い、これらは、発信時にユーザーへ到達したものとみなします。</p>
                <p>2. 当社は、本サービスの運営上重要と判断した事項について、本サービス上での表示、電子メールの送信、その他当社が適当と判断する方法により、ユーザーに通知することができるものとします。</p>
              </div>
            </section>

            {/* 権利義務の譲渡の禁止 */}
            <section>
              <h2 className="text-xl font-bold text-gray-900 mb-4">第14条（権利義務の譲渡の禁止）</h2>
              <div className="text-gray-700">
            ...
            {/* 適用法・裁判管轄 */}
            <section>
              <h2 className="text-xl font-bold text-gray-900 mb-4">第15条（適用法・裁判管轄）</h2>
              <div className="text-gray-700 space-y-3">
                <p>1. 本規約の解釈にあたっては、日本法を適用するものとします。</p>
            ...
            {/* お問い合わせ窓口 */}
            <section>
              <h2 className="text-xl font-bold text-gray-900 mb-4">第16条（お問い合わせ窓口）</h2>
              <div className="text-gray-700">
                <p className="mb-4">本規約に関するお問い合わせは、下記の窓口までお願いいたします。</p>
