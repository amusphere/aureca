...
export const metadata: Metadata = {
  title: 'プライバシーポリシー',
  description: 'プライバシーポリシー - 合同会社アミュスフィア',
};
        ...
        <div className="bg-white shadow-sm rounded-lg p-8">
          ...
          <div className="space-y-8">
            <div className="text-gray-700">
              <p>
                合同会社アミュスフィア（以下「当社」といいます。）は、本ウェブサイト上で提供するサービス（以下「本サービス」といいます。）における、
            ...
            {/* 個人情報の定義 */}
            <section>
              <h2 className="text-xl font-bold text-gray-900 mb-4">第1条（個人情報の定義）</h2>
