...
export default function AppSidebar() {
  ...
  return (
    <Sidebar className="border-r border-sidebar-border/40 bg-gradient-to-b from-sidebar to-sidebar/95">
      <SidebarHeader className="px-7 py-6 border-b border-sidebar-border/25 bg-sidebar/80 backdrop-blur-sm">
        <div className="flex items-center gap-4">
          <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-primary to-primary-hover text-primary-foreground shadow-lg shadow-primary/20">
            <Home className="h-4 w-4" />
          </div>
          <div className="flex flex-col gap-0.5">
            <h2 className="text-lg font-semibold text-sidebar-foreground tracking-tight leading-none">
              Task Manager
            </h2>
            <p className="text-xs text-sidebar-foreground/65 font-medium tracking-wide">
              Organize & Track
            </p>
          </div>
        </div>
      ...
      <SidebarFooter className="px-7 py-5 border-t border-sidebar-border/25 bg-gradient-to-r from-sidebar/90 to-sidebar/95 backdrop-blur-sm">
        <div className="flex items-center justify-between w-full">
          <div className="flex items-center gap-4 min-w-0 flex-1">
            <div className="flex items-center gap-3 p-2 rounded-lg bg-sidebar-accent/40 border border-sidebar-border/20 backdrop-blur-sm">
              {authSystem === 'clerk' ? (
                <ClerkUserButton />
              ) : (
